...
public class UICrosshairFollowWorld : MonoBehaviour
{
    ...
    [SerializeField] private Camera tpsCameraOverride;
    ...
    {
      if (tpsCameraOverride != null)
          return tpsCameraOverride;

     if (playerTPS != null && playerTPS.IsActive && playerTPS.OutputCamera != null)
           return playerTPS.OutputCamera;
    ...
    private void LateUpdate()
    {
        ...
        Camera activeCam = ResolveActiveCamera();
        ...
        Vector3 sp = activeCam.WorldToScreenPoint(worldTarget.position);
